...
from utils import format_messages, ModelArguments, throttle, catch_error_return_none
...
class OpenAIModel:
    ...
    KEY_ENV_VAR = "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"
    MAX_TOKENS = 4096
    ...
    def get_responses(self, batch, gen_config: dict = {}):
